...
#'           ndeps = c(alpha = -3.22530928172586, beta = -3.22530928172586, 
#'                     A = 6.80029379340371e-06, B = 6.80029379340371e-06, 
#'                     b = 0.001, 
#'                     tau = 0.0001848, sigma = 1.04461639852265e-06)), 
#'    fitted = list())
#'  
#'  vec.singleDose <- c(alpha = -1.38468866303807, beta = -1.38468866303807, 
#'                      A = 0.612026441406334, 
#'                      B = 0.612026441406334, 
#'                      b = 0.327121302070328, 
...
#'   initialGuess.vec = 
#'     c(M_alpha = 0.109108945117996, h_alpha = 3.16227766016838, 
...
#'   ), 
#'   fixed = c(M_alpha = NA, h_alpha = NA, K_alpha = NA, 
...
#'             sigma = NA, signum_TF = 1), 
#'   takeLog10 = c(M_alpha = TRUE, h_alpha = TRUE, K_alpha = TRUE, 
...
#'                 b = TRUE, 
#'                 sigma = FALSE), 
#'   positive.par.names = c("M_alpha", "h_alpha", "K_alpha", 
