...
#' corresponding model parameters ('finalParams'). Additionally the fitted 
#' parameters will be saved to files.
...
#' @param saveParams (Optional) Boolean, indicating if the fitted parameters 
#' should be saved to files (Default: TRUE).
...
#' generated by saveFinalParams() should be called ("[saveParamsFileString].tsv"
#' and "[saveParamsFileString].R"). If not specified it will be set to 
#' "fittedParams".
...
modelReduction <- function(res,
                           ...
                           saveParams = TRUE,
                           saveParamsFileString = "fittedParams") {
    modus <- res[["modus"]]
    res.orig <- res
    ...
    if (saveParams) saveFinalParams(res, fileString = saveParamsFileString)
